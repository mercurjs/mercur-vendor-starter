...
import ShippingForm, {
  ShippingFormType,
} from "../../../components/forms/product/shipping-form";
                    ...
                    <div className="gap-x-2xsmall flex items-center">
                      ...
                      {shipping_options && shipping_options.length === 0 && (
                        <IconTooltip
                          type="info"
                          content={
                            "To add shipping methods, you must first initialize them in Settings -> Shipping Options"
                          }
                        />
                      )}
                    </div>
                    <p className="inter-base-regular text-grey-50 mb-large">
                      Set shipping methods for the product.
                    </p>
                    <ShippingForm form={nestedForm(form, "delivery")} />
                  </div>
                  <div>
...
const createPayload = (
  ...
  const payload: AdminPostProductsReq = {
    ...
    // @ts-ignore
    shipping_options: data.delivery.shipping_options?.length
      ? data.delivery.shipping_options
      : [],
