...
const CustomerDetail = () => {
  ...
  return (
    <div>
      <BackButton label={t('details-back-to-customers', 'Back to Customers')} path="/a/customers" className="mb-xsmall" />
          ...
          <div className="mt-6 flex space-x-6 divide-x">
            ...
            <div className="h-100 flex flex-col pl-6">
              ...
              <div className="h-50 flex items-center justify-center">
                <StatusDot variant={customer.has_account ? 'success' : 'danger'} title={customer.has_account ? 'Registered' : 'Guest'} />
              </div>
            </div>
          </div>
        </Section>
