...
const defaultQueryProps = {
  ...
  expand: "variants,options,variants.prices,variants.options,tags,type,images",
  is_giftcard: false,
};
...
const ProductTable = ({ onBulkSelectionChange }: ProductTableProps) => {
  ...
  if (isFeatureEnabled("sales_channels")) {
    defaultQueryProps.expand =
      "variants,options,variants.prices,variants.options,tags,type,images,sales_channels";
    hiddenColumns = [];
  }
